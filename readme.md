...
в main.c файле написал код для генерации ast дерева разбора каждой функции

я хочу чтобы вместо этих файлов генерировались файлы но с графом потока управления каждой функции

у тебя уже есть генерация ast дерева

его нужно просто преобразовать в граф потока управления и вывести граф потока управления вместо ast дерева

нужно учитывать все нюансы при создании графа потока управления

у тебя есть грамматика языка в файле grammar.js